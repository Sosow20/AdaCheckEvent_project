...
function Calendar() {
  ...
  return (
    <div className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow inline-flex items-center gap-2 m-px mt-10 ml-8">
      ...
      <button className= "bg-white  text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow inline-flex gap-1 items-center m-px">Reset
      ...
      <button className= "bg-white  text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow inline-flex gap-1 items-center m-px">Trier
